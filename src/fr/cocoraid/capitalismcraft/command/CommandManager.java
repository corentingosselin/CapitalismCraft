...
import fr.cocoraid.capitalismcraft.command.commands.empereur.EmpereurCMD;
...
public class CommandManager {
    ...
    public CommandManager(CapitalismCraft instance) {
        ...
        instance.getCommand("build").setExecutor(new BuilderCMD(instance));
        instance.getCommand("emp").setExecutor(new EmpereurCMD());
    }
