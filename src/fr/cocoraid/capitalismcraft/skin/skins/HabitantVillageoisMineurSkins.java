...
public class HabitantVillageoisMineurSkins implements SkinLoader {
    ...
    public List<Skin> loadSkins() {
        ...
        list.add(new Skin("&7Habitant", Gender.MALE, SkinRarity.BASIC,
        ...
        list.add(new Skin("§7Habitant", Gender.MALE, SkinRarity.RARE,
        ...
        list.add(new Skin("§7Habitant", Gender.MALE, SkinRarity.NORMAL,
        ...
        list.add(new Skin("§7Habitant", Gender.MALE, SkinRarity.COMMON,
        ...
        list.add(new Skin("§7Habitante" , Gender.FEMALE, SkinRarity.RARE,
        ...
        list.add(new Skin("§7Habitante",  Gender.FEMALE,SkinRarity.NORMAL,
        ...
        list.add(new Skin("&7Habitante", Gender.FEMALE, SkinRarity.MEDIUM,
        ...
        list.add(new Skin("§7Habitante", Gender.FEMALE, SkinRarity.COMMON,
        ...
        list.add(new Skin("§7Habitante", Gender.FEMALE, SkinRarity.BASIC,
        ...
        list.add(new Skin("§7Habitante", Gender.FEMALE, SkinRarity.EXTRA,
